...
<body>
    <div class="card">
        <h2>Cone</h2>
        <img src="cone.png" alt="Fórmulas do Cone">
        <form method="post">
            <label>Raio da base (r):</label><br>
            ...
            <input type="number" name="g" step="0.01" required><br>
        ...
        <div class="resultado">
            <%
                ...
                if (rStr != null && hStr != null && gStr != null) {
                    try {
